...
def test_sum_no_lift_everything(duckdb_conn):
    ...
    assert(res[0][0] == "{'N': 5, 'lin_agg': [15.0, 17.0, 22.0], 'quad_agg': [59.0, 91.0, 112.0], 'lin_cat': [[{'key': 4, 'value': 3.0}, {'key': 8, 'value': 2.0}], [{'key': 5, 'value': 1.0}, {'key': 6, 'value': 2.0}, {'key': 9, 'value': 1.0}, {'key': 10, 'value': 1.0}], [{'key': 6, 'value': 1.0}, {'key': 8, 'value': 2.0}, {'key': 10, 'value': 1.0}, {'key': 12, 'value': 1.0}]]}");
...
def test_sum_no_lift_group_by(duckdb_conn):
    ...
    res = duckdb_conn.fetchall()
    assert(res[0][0] == "{'N': 2, 'lin_agg': [6.0, 8.0, 10.0], 'quad_agg': [26.0, 40.0, 58.0], 'lin_cat': [[{'key': 4, 'value': 1.0}, {'key': 8, 'value': 1.0}], [{'key': 5, 'value': 1.0}, {'key': 9, 'value': 1.0}], [{'key': 6, 'value': 1.0}, {'key': 10, 'value': 1.0}]]}");
    assert(res[1][0] == "{'N': 3, 'lin_agg': [9.0, 9.0, 12.0], 'quad_agg': [33.0, 51.0, 54.0], 'lin_cat': [[{'key': 4, 'value': 2.0}, {'key': 8, 'value': 1.0}], [{'key': 6, 'value': 2.0}, {'key': 10, 'value': 1.0}], [{'key': 8, 'value': 2.0}, {'key': 12, 'value': 1.0}]]}");
...
def test_sum_no_lift_having (duckdb_conn):
    ...
    res = duckdb_conn.fetchall()
    assert(res[0][0] == "{'N': 3, 'lin_agg': [9.0, 9.0, 12.0], 'quad_agg': [33.0, 51.0, 54.0], 'lin_cat': [[{'key': 4, 'value': 2.0}, {'key': 8, 'value': 1.0}], [{'key': 6, 'value': 2.0}, {'key': 10, 'value': 1.0}], [{'key': 8, 'value': 2.0}, {'key': 12, 'value': 1.0}]]}");
